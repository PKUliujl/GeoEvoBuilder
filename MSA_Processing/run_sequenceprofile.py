...
import argparse
parser = argparse.ArgumentParser(description="Transform the MSA information to the sequence profile distribution")
parser.add_argument('-i', '--input', type=str, required=True, help="Input file (aln format)")
parser.add_argument('-s', '--scale', type=float, default=1, help="Scaling factor. Utilizing smaller values leads to a sharper distribution")
